var treeSketch = function(sketch) {
    ...
    sketch.preload = function() {
        ...
        const yamlContent = sketch.loadStrings('/scripts/2024-11-26-world-building-tree/ironbound_world.yaml', result => {
      ...
      sketch.setup = function() {
        ...
        sketch.clear();
        canvas.parent('simple-example-holder-3');
        ...
        descriptionText.id('description-text-3'); // Assign an ID for easy selection
        ...
        calculatePositions(root, 40, 2*(sketch.height / 3), 1*(sketch.height / 3)); // Assign positions
    ...
    sketch.mouseReleased = function () {
        if (draggedNode) {
            ...
            let descriptionText = sketch.select('#description-text-3');
  ...
  let myTreeSketch3 = new p5(treeSketch, 'simple-example-holder-3');
